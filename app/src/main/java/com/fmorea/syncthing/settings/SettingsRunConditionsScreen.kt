...
fun SettingsRunConditionsScreen() {
    ...
    var runOnMobileData by rememberPreferenceState(Constants.PREF_RUN_ON_MOBILE_DATA, true)
    ...
    SettingsScaffold(
        ...
        item {
            val isLocationEnabled = com.fmorea.syncthing.util.PermissionUtil.haveLocationPermission(context)
            if (runOnWifi && !isLocationEnabled) {
                androidx.compose.material3.Card(
                    ...
                    Text(
                        text = "La funzione 'Solo su WiFi' richiede i permessi di posizione per identificare la rete. Tocca 'Specifica reti WiFi' per attivarli.",
                        modifier = Modifier.padding(16.dp),
